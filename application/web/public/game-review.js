      ...
      postReviewButton.addEventListener('click', async () => {
          ...
          try {
            const response = await fetch('http://127.0.0.1:8000/api/reviews', {
                ...
                credentials: 'include', // Sends session cookies or tokens
                body: JSON.stringify({
            ...
            console.log('Fetch Response:', response); // Logs the entire response
            ...
            if (response.ok) {
                ...
                console.error('Error details:', errorData); // Log the server error details
